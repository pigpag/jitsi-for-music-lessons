...
```
URL=https://raw.githubusercontent.com/pigpag/jitsi-for-music-lessons/main/linode-jitsi.sh; CONTENT=$(curl -sL $URL); [ $(md5sum<<<"$CONTENT" | head -c 32) = "c3ba05ab15404811143b247f41d8dc68" ] && sudo bash -c "$CONTENT"
```
