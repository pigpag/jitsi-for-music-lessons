...
```
URL=https://raw.githubusercontent.com/pigpag/jitsi-for-music-lessons/main/linode-jitsi.sh; CONTENT=$(curl -sL $URL); [ $(md5sum<<<"$CONTENT" | head -c 32) = "355430a8a85de9c7dcacbc5a80f4dca9" ] && sudo bash -c "$CONTENT"
```
